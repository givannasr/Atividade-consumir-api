...
export default function TodosCliente() {
    ...
    const navegaEditarCliente = (pId, pNome, pTelCel, pTelFixo, pEmail) => {
        navigation.navigate('EditarCliente', { id: pId, NOME: pNome, TEL_CEL: pTelCel, TEL_FIXO: pTelFixo, EMAIL: pEmail });
    };
    ...
    */
    ...
    let listItemView = (item) => {
        return (
            ...
            <View
                key={item.id}
                style={{ backgroundColor: '#A6DCEE', marginBottom: 30, padding: 15, borderRadius: 10, shadowColor: 'black', elevation: 8 }}>
                ...
                <Text style={styles.textheader}>Telefone Celular</Text>
                <Text style={styles.textbottom}>{item.TEL_CEL}</Text>

                <Text style={styles.textheader}>Telefone Fixo</Text>
                <Text style={styles.textbottom}>{item.TEL_FIXO}</Text>
                ...
                <View style={[styles.container, styles.alignVH]}>
                    ...
                    >
                        ...
                        <FontAwesome5 name="trash-alt" color='BLACK' size={24} />
                    </TouchableOpacity>
                    <TouchableOpacity
                        onPress={() => {
                            navegaEditarCliente(item.id, item.NOME, item.TEL_CEL, item.TEL_FIXO, item.EMAIL);
                            // setFlatListItems([]);
                        }}>
